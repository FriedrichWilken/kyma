...
require (
	...
	github.com/kyma-project/kyma/common/logging v0.0.0-20220520122626-3a5cb3177ab0
	github.com/kyma-project/kyma/components/application-operator v0.0.0-20220520122626-3a5cb3177ab0
